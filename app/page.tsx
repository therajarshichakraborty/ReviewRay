  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-6 ">
      <Card className="w-full max-w-md shadow-lg border border-border">
        <CardHeader>
          <CardTitle className="text-2xl font-bold tracking-tight">Project Overview</CardTitle>
          <CardDescription>
        ...
        <CardContent className="space-y-4 text-sm text-muted-foreground">
          ...
          <div className="rounded-lg bg-muted p-3 font-mono text-xs text-foreground">pnpm dev</div>
        </CardContent>
